...
function createInstructions() {
	...
	text.style.left = ((119 - text.clientWidth) / 2) +'px';
	text.style.top = ((119 - text.clientHeight) / 2) +'px';
...
function createInstructions2() {
	...
	text.style.left = ((80 - text.clientWidth) / 2) +'px';
	text.style.top = ((80 - text.clientHeight) / 2) +'px';
