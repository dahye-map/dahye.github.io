...
<%
	Class DBHelperCls
		...
		private sub Class_Initialize()
			'DefaultConnString = "Provider=SQLOLEDB.1;Password=ehdtj!2#4;Persist Security Info=True;User ID=dongsuh;Initial Catalog=dongsuh_2015;Data Source=localhost"
			'DefaultConnString = application("db_constr")
