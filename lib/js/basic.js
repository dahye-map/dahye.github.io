...
// 전체메뉴 검색 placeholder
$(".menu_all .inputTypeText").attr("placeholder", "search").focusin(function(){
    $(this).attr("placeholder", "");
});

//네비 2depth
var _isSlide = false;
$('#navWrap .nav .nav-list > li > a').click(function() {
...
$('#headerWrap .marquee-close').click(function(){
    $(this).hide();
    $('#headerWrap .marquee-div').css('height', '0');
    $('#headerWrap .header').css('top', '0');
    $('#containerWrap .container').css('margin-top','0');
    $('#canvas').css('top','-56px;');
});
